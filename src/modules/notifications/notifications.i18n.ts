...
const notificationStrings: Record<
  SupportedLocale,
...
> = {
  'pt-BR': {
    'notification.orderCreated': {
      ...
      message:
        'O usuário {{userName}} realizou um novo pedido (#{{orderCode}}).',
    },
    ...
    'notification.receiptRejected': {
      ...
      message:
        'O comprovante do pedido #{{orderCode}} não pôde ser validado. Por favor, envie um novo comprovante.',
    },
    ...
    'notification.paymentReverted': {
      ...
      message:
        'O status do seu pedido #{{orderCode}} foi alterado. Por favor, verifique os detalhes.',
    },
    ...
    'notification.orderFormClosed': {
      ...
      message:
        'O formulário de encomenda foi concluído. Obrigado pelo seu pedido!',
    },
    'notification.expressOrderCreated': {
      title: '🚀 Novo Pedido Expresso',
      message:
        'O usuário {{userName}} realizou um novo pedido expresso (#{{orderCode}}).',
    },
    ...
    'notification.newUserRegistered': {
      ...
      message:
        'O usuário {{userName}} ({{userEmail}}) acabou de se cadastrar no app.',
    },
  },
  'ja-JP': {
    'notification.orderCreated': {
    ...
    'notification.receiptRejected': {
      title: '❌ 領収書却下',
      message:
        '注文 #{{orderCode}} の領収書は確認できませんでした。新しい領収書を送付してください。',
    },
    'notification.orderCancelledByAdmin': {
      title: '🚫 注文キャンセル',
    ...
    'notification.paymentReverted': {
      title: '↩️ 支払いステータス変更',
      message:
        '注文 #{{orderCode}} のステータスが変更されました。詳細をご確認ください。',
    },
    'notification.newOrderForm': {
      title: '📋 新規注文フォーム',
    ...
    'notification.expressOrderCreated': {
      title: '🚀 新規エクスプレス注文',
      message:
        '{{userName}}さんが新しいエクスプレス注文（#{{orderCode}}）を行いました。',
    },
    'notification.expressOrderConfirmed': {
      title: '✅ エクスプレス注文確認済み',
...
export function buildNotificationMessage(
  ...
  const localeStrings =
    notificationStrings[locale] ?? notificationStrings['pt-BR'];
