...
export class OrdersController {
  ...
  create(
    ...
    return this.comBroadcast(
      'INSERT',
      this.ordersService.create(userId, createOrderDto),
    );
  }
  ...
  @ApiResponse({
    status: 400,
    description: 'Prazo expirado ou pedido não pode ser editado',
  })
  @ApiResponse({
    status: 403,
  ...
  update(
    ...
    return this.comBroadcast(
      'UPDATE',
      this.ordersService.update(id, userId, updateOrderDto),
    );
  }
  ...
  @ApiResponse({
    status: 400,
    description: 'Prazo expirado ou status inválido',
  })
  @ApiResponse({
    status: 403,
    description: 'Sem permissão para cancelar este pedido',
  })
  cancelMyOrder(
    @Param('id', ParseIntPipe) id: number,
    @CurrentUser('id') userId: string,
    ...
    return this.comBroadcast(
      'UPDATE',
      this.ordersService.cancelMyOrder(id, userId),
    );
  }
  ...
  confirmPayment(
    ...
    return this.comBroadcast(
      'UPDATE',
      this.ordersService.confirmPayment(id, adminUserId),
    );
  }
  ...
  rejectPayment(
    ...
    return this.comBroadcast(
      'UPDATE',
      this.ordersService.rejectPayment(id, adminUserId),
    );
  }
  ...
  cancelOrder(
    ...
    return this.comBroadcast(
      'UPDATE',
      this.ordersService.cancelOrder(id, adminUserId),
    );
  }
  ...
  revertCancellation(
    ...
    return this.comBroadcast(
      'UPDATE',
      this.ordersService.revertCancellation(id, adminUserId),
    );
  }
  ...
  @ApiResponse({
    status: 200,
    description: 'Lista de pedidos do formulário retornada',
  })
  findByOrderForm(
